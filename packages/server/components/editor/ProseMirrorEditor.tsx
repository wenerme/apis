...
import {proseMirrorSetup} from 'components/editor/prosemirror/setup';
...
export const ProseMirrorEditor: React.FC<{ style?: CSSProperties, editor: EditorInstance }> = ({style, editor}) => {
