...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c0 = function(): any {return options?.allowedPredefined ?? true};
  const peg$c1 = function(head: any, v: any): any {return v};
  const peg$c2 = function(head: any, tail: any): any {return [].concat(head,tail)};
  const peg$c3 = "*";
  const peg$c4 = peg$literalExpectation("*", false);
  const peg$c5 = "?";
  const peg$c6 = peg$literalExpectation("?", false);
  const peg$c7 = function(): any {return {type:'any', mark: text() }};
  const peg$c8 = "/";
  const peg$c9 = peg$literalExpectation("/", false);
  const peg$c10 = function(interval: any, nth: any): any {return {type:'step', interval, nth}};
  const peg$c11 = function(nth: any): any {return {type:'any-step', nth}};
  const peg$c12 = function(range: any, nth: any): any {return {...range, type:'range-step', nth}};
  const peg$c13 = "-";
  const peg$c14 = peg$literalExpectation("-", false);
  const peg$c15 = function(from: any, to: any): any {return {type:'range', from, to}};
  const peg$c16 = ",";
  const peg$c17 = peg$literalExpectation(",", false);
  const peg$c18 = function(head: any, tail: any): any {return {type:'list',values: [].concat(head,tail)}};
  const peg$c19 = function(head: any, tail: any): any {return {type:'day-of-week-list',values: [].concat(head,tail)}};
  const peg$c20 = function(head: any, tail: any): any {return {type:'month-of-year-list',values: [].concat(head,tail)}};
  const peg$c21 = "#";
  const peg$c22 = peg$literalExpectation("#", false);
  const peg$c23 = /^[1-5]/;
  const peg$c24 = peg$classExpectation([["1", "5"]], false, false);
  const peg$c25 = function(dow: any): any {return parseInt(text())};
  const peg$c26 = function(dow: any, nth: any): any {return {type:'day-of-week-nth', nth,dow}};
  const peg$c27 = "SUN";
  ...
  const peg$c41 = function(): any {return dayOfWeek(text())};
  const peg$c42 = "JAN";
  ...
  const peg$c66 = function(): any {return monthOfYearNames(text())};
  const peg$c67 = "L";
  const peg$c68 = peg$literalExpectation("L", false);
  const peg$c69 = function(dow: any): any {return {type:'last-day-of-week-of-month', dow}};
  const peg$c70 = "LW";
  const peg$c71 = peg$literalExpectation("LW", false);
  const peg$c72 = function(): any {return {type:'last-weekday-of-month'}};
  const peg$c73 = "W";
  const peg$c74 = peg$literalExpectation("W", false);
  const peg$c75 = function(nth: any): any {return {type: 'nearest-weekenday', nth}};
  const peg$c76 = "L-";
  const peg$c77 = peg$literalExpectation("L-", false);
  const peg$c78 = function(days: any): any {return {type: 'days-before-end-of-month', days}};
  const peg$c79 = "@";
  const peg$c80 = peg$literalExpectation("@", false);
  const peg$c81 = function(name: any): any {return {type:'predefined', name}};
  ...
  const peg$c99 = function(v: any): any {return v >=0 && v<=7};
  const peg$c100 = function(v: any): any {return v};
  const peg$c101 = peg$otherExpectation("dom");
  const peg$c102 = function(v: any): any {return v >=0 && v<=31};
  const peg$c103 = /^[0-9]/;
