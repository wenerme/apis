...
import {getJsBarcodeFormat} from 'libs/barcodes/formats';
import JsBarcode from 'jsbarcode';

export type BarcodeOptions = JsBarcode.Options & { target?: Element, value?, xmlDocument?, renderFormat?, renderer? }
...
async function renderSvg(options: BarcodeOptions) {
  if (!document) {
    await import('xmldom')
      .then(({DOMImplementation, XMLSerializer}) => {
