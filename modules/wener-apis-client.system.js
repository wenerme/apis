System.register([], function (exports) {
  ...
  return {
    execute: function () {
      ...
      exports({
        consumeClientService: consumeClientService,
        getServiceMetadataOfType: getServiceMetadataOfType,
        getServicePathOfCoordinate: getServicePathOfCoordinate,
        overrideClientService: overrideClientService
      });
       ...
       * @publicApi
       */
      function getServicePathOfCoordinate(coord) {
        const {
          group = 'default',
          service,
          version = '1.0.0'
      ...
      function getServiceMetadataOfType(type) {
        return {
      ...
      const ServiceNameAttribute = exports('ServiceNameAttribute', 'service');
      const ServiceGroupAttribute = exports('ServiceGroupAttribute', 'group');
      const ServiceVersionAttribute = exports('ServiceVersionAttribute', 'version');
      ...
      class ServiceConsumerManager {
        constructor() {
          this.client = axios$1.create({
            baseURL: './api/service',
            timeout: 30000 // headers: {'X-Custom-Header': 'foobar'}
        ...
        consume(coord) {
          ...
          if (this._provider) {
            var _this$_provider$findR;

            const target = (_this$_provider$findR = this._provider.findRegistry(options)) === null || _this$_provider$findR === void 0 ? void 0 : _this$_provider$findR.target;
          ...
          return this._services[key] || (this._services[key] = new Proxy({}, new ServiceProxy({
            client,
            options: options
          })));
        }
      ...
      class ServiceProxy {
        ...
        get(target, p, receiver) {
          ...
          return this._methods[p] = async (...params) => {
            const path = `${getServicePathOfCoordinate(this.options)}/invoke/${method}`;
            let resp;
      ...
      function normalizeError(e) {
        return {
          status: e.status || 500,
          message: e.message || Object.prototype.toString.call(e)
        };
      }
      ...
      class ServiceMetadata {
        ...
        async invoke(invoke) {
          ...
          const method = this.methods[methodName]; // 不允许 _ 开头的方法
      ...
      class ServiceProviderManager {
        ...
        findRegistry(query) {
          var _this$_services$getSe;

          return (_this$_services$getSe = this._services[getServicePathOfCoordinate(query)]) === null || _this$_services$getSe === void 0 ? void 0 : _this$_services$getSe.registration;
        }
      ...
      var title = "RPC Client";
      var description = "远程调用客户端";
      var metadata = exports('metadata', {
      	title: title,
      	description: description
      });

      class PasswordStrengthService {} exports('PasswordStrengthService', PasswordStrengthService);
      PasswordStrengthService.service = 'me.wener.apis.password.PasswordStrengthService';

      class PhoneAttributionService {} exports('PhoneAttributionService', PhoneAttributionService);
      PhoneAttributionService.service = 'me.wener.apis.phone.PhoneAttributionService';

      class HashingService {} exports('HashingService', HashingService);
      HashingService.service = 'me.wener.apis.hash.HashingService';
      ...
      PingService[ServiceNameAttribute] = 'me.wener.test.PingService';
      PingService.instance = new PingService();

      const client = new ServiceConsumerManager();
      const provider = new ServiceProviderManager();
      client.provider = provider;
      const ClientConsumers = exports('ClientConsumers', client);
      function consumeClientService(coord) {
        return client.consume(coord);
      }
      function overrideClientService(s) {
        provider.registry(s);
      } // ========== SERVICES
...
//# sourceMappingURL=wener-apis-client.system.js.map
